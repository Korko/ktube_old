...
_store2.default.dispatch('APPEND', videos, hasMore);

},{"./store.js":12,"vue":4}],9:[function(require,module,exports){
'use strict';
...
_vue2.default.filter('fromNow', function (value) {
	return moment(value, 'YYYY-MM-DD HH:mm:ss').fromNow();
});

(0, _vuexRouterSync.sync)(_store2.default, _routes2.default);
_routes2.default.start(_app2.default, '#root');

},{"./app.js":8,"./routes.js":10,"./store.js":12,"vue":4,"vuex-router-sync":6}],10:[function(require,module,exports){
'use strict';
...
},{"../vue/404.vue":13,"../vue/Videos.vue":14,"vue":4,"vue-router":3}],11:[function(require,module,exports){
'use strict';
...
exports.default = new _vuex2.default.Store({
	...
	mutations: {
		APPEND: function APPEND(state, videos, hasMore) {
			_vue2.default.set(state, 'videos', state.videos.concat(videos));
			state.hasMore = hasMore === undefined ? state.hasMore : hasMore;
		},
		PREPEND: function PREPEND(state, videos) {
			_vue2.default.set(state, 'videos', videos.concat(state.videos));
		}
	},
	strict: true
});

},{"vue":4,"vuex":7}],13:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/var/www/ktube.yt/dev/resources/assets/vue/404.vue"
...
},{"vue":4,"vue-hot-reload-api":2,"vueify-insert-css":5}],14:[function(require,module,exports){
...
exports.default = {
        ...
        vuex: {
                ...
                actions: {
                        appendVideos: function appendVideos(store, videos, hasMore) {
                                store.dispatch('APPEND', videos, hasMore);
                        },
                        prependVideos: function prependVideos(store, videos) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/var/www/ktube.yt/dev/resources/assets/vue/Videos.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n        .video-thumbnail {\n                float: left;\n                width: 350px;\n        }\n\n        .video-data {\n                float: left;\n                clear: right;\n        }\n\n        .video_thumbnail {\n                width: 100px;\n                height: 100px;\n                display: inline-block;\n        }\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":4,"vue-hot-reload-api":2,"vueify-insert-css":5}]},{},[11,9]);
